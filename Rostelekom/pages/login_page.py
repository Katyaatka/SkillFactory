...
class LoginPage(BasePage):
    ...
    def login_with_number_and_params(self, numbers, passwords):
        '''Метод для ввода номера телефона, пароля и авторизации пользователя'''

        self.click(self.LOGIN_WITH_PASS)
        self.click(self.BTN_NUMBER)
        self.enter_text(self.LOGIN_INPUT, numbers)
        self.enter_text(self.PASSWORD_INPUT, passwords)
        self.click(self.BUTTON_LOGIN)

    def login_with_mail_and_params(self, mails, passwords):
        '''Метод для ввода номера почты, пароля и авторизации пользователя'''

        self.click(self.LOGIN_WITH_PASS)
        self.click(self.BTN_MAIL)
        self.enter_text(self.LOGIN_INPUT, mails)
        self.enter_text(self.PASSWORD_INPUT, passwords)
        self.click(self.BUTTON_LOGIN)